...
$('#opt').on('change',function(){
    var valor = $(this).val();
	if(valor!=""){
	var texto=$("#opt option:selected").text();
	//console.log(texto);
	var areatexto=$("#fp-observation").val(texto);
	}
})
</script>
<style>
...
<div class="ctr-form-process" style="min-height:550px; ">
	<div class="content-process" id="ctr-process" >
    	<form id="form-process" name="formprocess" class="f-process" style="width:75%; margin:0 auto;">
...
?>
            ...
            <div class="ctr-obs" align="center">
                ...
                <select name="opt" id="opt" class="required">
                  <option value="">_Seleccione
                  <option value="CS">Por crediseguro
                  <option value="FSUD">Funcionario sudamericana
                  <option value="FCRE">Funcionario crecer
              </select>
	              <textarea id="fp-observation" name="fp-observation" class="required" cols="1000" rows="4"></textarea><br>
            </div>
