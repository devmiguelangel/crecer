...
FROM 
	...
	inner join s_de_facultativo t6 on t0.id_emision = t6.id_emision 
	left outer join s_de_pendiente t7 on t0.id_emision = t7.id_emision 
	left outer join s_estado t8 on t8.id_estado =  t7.id_estado

WHERE t01facultativo = 1 and t0.emitir = 0 and t6.aprobado='SI' and t0.anulado = 0
...
$shtml="<table border='0' cellspacing='1' cellpadding='0' style='width:150%; font-size:9pt;'>";
			...
			$shtml.='<tr style="background:#D3DCE3;">
				...
				while($resutadodes=mysql_fetch_array($consultades)){
						 ...
						 $shtml.='<td align="center">DE-'.$resutadodes['no_emision'].'</td>
