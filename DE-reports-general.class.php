    ...
    private function set_query_de_report(){
        ...
        where
            sef.id_ef = '".$this->data['idef']."'
                ...
                or su.id_usuario like '%".$this->data['idUser']."%')
...
?>
        <tr style=" <?=$bg;?> " class="row" rel="0" 
            ...
            <td <?= $rowSpan ;?>><?= $this->cx->coverage[(int)$this->row['cobertura']] ;?></td>
            ...
            <td><?php 
                  if($this->row['r_moneda']==='Dolares'){
                     ...
                     $this->rowcl['cl_saldo']=($this->rowcl['cl_saldo']/$change);
                    echo number_format($this->rowcl['cl_saldo'],2,'.',',')." USD";
                      }else{
                    echo number_format($this->rowcl['cl_saldo'],2,'.',',')." Bs";
                      }
            ?>
            ...
            <td><?php 
                 if($this->row['r_moneda']==='Dolares'){
                     $change=$this->getChange();
                     $this->rowcl['cl_cumulo']=($this->rowcl['cl_cumulo']/$change);
            echo number_format($this->rowcl['cl_cumulo'],2,'.',',')." USD";
                 }else{
                    echo number_format($this->rowcl['cl_cumulo'],2,'.',',')." Bs"; 
                     }
