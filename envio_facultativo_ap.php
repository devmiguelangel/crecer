...
$selectdes = "SELECT t0.no_emision, t2.nombre, t2.paterno, t2.materno, t6.aprobado, t0.emitir, t2.ci, case t2.genero when 'F' then 'Femenino' when 'M' then 'Masculino' end as genero, t2.localidad, t2.telefono_celular, t2.telefono_domicilio, t2.email, t2.estatura, t2.peso, t2.edad, t0.motivo_facultativo, datediff(t6.fecha_creacion,t0.fecha_creacion) AS proceso, t6.tasa_recargo, t6.porcentaje_recargo, t6.tasa_actual, t6.tasa_final, t6.observacion, t0.monto_solicitado, t0.moneda, t1.cumulo, t0.fecha_creacion, t5.agencia, t3.usuario, t3.nombre as nom_us, t3.email as email_us, t0.hora_creacion, t1.detalle_f, t1.monto_banca_comunal, t1.motivo_facultativo as mot_fac
...
WHERE t1.facultativo = 1 and t0.emitir =1 and (t6.aprobado='SI' or t6.aprobado='NO') and t0.anulado = 0
    ...
    if ($mostrar == "si") {
        ...
        if ($resutadodes['detalle_f'] != '') {
            ...
            $shtml.='<td align="center">' . $resutadodes['mot_fac'] . '</td>
								  <td align="center">' . $det["tasa_recargo"] . '</td>
								  <td align="center">' . $det["porcentaje_recargo"] . '</td>
								  <td align="center">' . $det["tasa_actual"] . '</td>
								  <td align="center">' . $det["tasa_final"] . '</td>
								  <td align="center">' . $det["observacion"] . '</td>
